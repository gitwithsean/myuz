    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chapter', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='noveller.chapter')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avoid', models.ManyToManyField(blank=True, related_name='litstyleguide_avoid', to='noveller.literarytraits')),
                ('character', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='noveller.character')),
                ('character_version', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='noveller.characterversion')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subplot_of', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='plots_events', to='noveller.plot')),
            ],
            options={
                'ordering': ['name'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=200)),
                ('elaboration', models.TextField(blank=True, null=True)),
                ('book', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='books_audience', to='noveller.book')),
            ],
            options={
                'ordering': ['name'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=200)),
                ('elaboration', models.TextField(blank=True, null=True)),
                ('character', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='noveller.characterversion')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bg_events', models.ManyToManyField(blank=True, to='noveller.bgevent')),
                ('bg_research', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='noveller.bgresearch')),
        ...
        migrations.AddField(
            ...
            name='perspective',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='noveller.perspective'),
        ),
        migrations.AddField(
            model_name='litstyleguide',
            name='symbolism',
        ...
        migrations.AddField(
            model_name='litstyleguide',
            name='traits',
            field=models.ManyToManyField(blank=True, related_name='litstyleguide_traits', to='noveller.literarytraits'),
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=200)),
                ('elaboration', models.TextField(blank=True, null=True)),
                ('book', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='books_genres', to='noveller.book')),
            ],
            options={
                'ordering': ['name'],
                'abstract': False,
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='character_versions', to='noveller.characterversion'),
        ),
        migrations.AddField(
            model_name='characterrelationship',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('character', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='noveller.characterversion')),
        ...
        migrations.AddField(
            model_name='book',
            name='plot',
            field=models.ManyToManyField(blank=True, related_name='books_events', to='noveller.plotevent'),
        ),
        migrations.AddField(
            model_name='book',
            name='settings',
        ...
        migrations.AddField(
            model_name='book',
            name='themes',
            field=models.ManyToManyField(blank=True, related_name='book_themes', to='noveller.theme'),
        ),
        migrations.AddField(
            model_name='bgresearch',
            name='deeper_bg_research_topic',
            field=models.ManyToManyField(blank=True, to='noveller.deeperbgresearchtopic'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='subplot',
            name='sub_plot_of',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='plots_subplot', to='noveller.plot'),
        ),
    ]
