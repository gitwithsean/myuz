    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='book_characters', to='noveller.book')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('beliefs', models.ManyToManyField(blank=True, null=True, to='noveller.belief')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('members', models.ManyToManyField(blank=True, null=True, to='noveller.characterversion')),
            ],
            options={
                'ordering': ['name'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avoid', models.ManyToManyField(blank=True, null=True, related_name='litstyleguide_avoid', to='noveller.literarytrait')),
                ('imagery', models.ManyToManyField(blank=True, null=True, to='noveller.literaryimagery')),
                ('inspirations', models.ManyToManyField(blank=True, null=True, to='noveller.literaryinspirationperson')),
            ],
            options={
                'ordering': ['name'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=200, unique=True)),
                ('elaboration', models.TextField(blank=True, null=True)),
                ('book', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='books_plots', to='noveller.book')),
            ],
            options={
                'ordering': ['name'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('foreshadowing', models.ManyToManyField(blank=True, null=True, related_name='SubPlotEvent', to='noveller.plotevent')),
            ],
            options={
                'ordering': ['name'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lit_style_guide', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='noveller.litstyleguide')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('background_events', models.ManyToManyField(blank=True, null=True, to='noveller.backgroundevent')),
                ...
                ('books', models.ManyToManyField(blank=True, null=True, to='noveller.book')),
                ('factions', models.ManyToManyField(blank=True, null=True, to='noveller.faction')),
            ],
            options={
                'ordering': ['name'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=200, unique=True)),
                ('elaboration', models.TextField(blank=True, null=True)),
                ('character_versions', models.ManyToManyField(blank=True, null=True, related_name='locations_in_character_version', to='noveller.characterversion')),
            ],
            options={
                'ordering': ['name'],
                'abstract': False,
