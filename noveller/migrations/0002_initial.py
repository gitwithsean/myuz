    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agent_assignments_for_project', models.ManyToManyField(blank=True, default=[], related_name='projects_for_agent_assignment', to='phusis.agentassignment')),
            ],
            options={
                'ordering': ['name'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('foreshadowing', models.ManyToManyField(blank=True, related_name='SubPlotEvent', to='noveller.scene')),
        ...
        migrations.AddField(
            model_name='characterversion',
            name='relationships',
            field=models.ManyToManyField(blank=True, null=True, to='noveller.characterrelationship'),
        ),
        migrations.AddField(
            model_name='characterversion',
        ...
        migrations.CreateModel(
            name='SubPlotScene',
            fields=[
                ('scene_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='noveller.scene')),
                ('subplot', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='subplots_scenes', to='noveller.subplot')),
            ],
            options={
                'ordering': ['order_in_story_events'],
            },
            bases=('noveller.scene',),
        ),
        migrations.AddField(
            model_name='subplot',
            name='scenes_of_subplot',
            field=models.ManyToManyField(blank=True, related_name='subplots_scenese', to='noveller.subplotscene'),
        ),
        migrations.AddField(
            model_name='subplot',
            name='sub_plot_of',
